 ...
 *        with the same ID (see "initGameStateLabels" in bi.game.php)
 *
...
$game_options = array(
    100 => [
        ...
        'values'  => [
            1 => [
                'name'        => totranslate('full game'),
            ],
            2 => [
                'name'        => totranslate('short game'),
                'description' => totranslate('cards randomly removed to shorten game'),
            ],
        ],
        'default' => 1,
    ],
